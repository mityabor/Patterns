...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
    	...
    	public void handleMessage(Message msg) {
    		...
    		if (activity != null) {
    			...
    			Log.d(this.getClass().getSimpleName() , msg.getData().getString("PATHNAME"));
    ...
    public void runService(View view) {
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	Intent serviceThreadPool = ThreadPoolDownloadService.makeIntent(this, handler, getUrlString());
